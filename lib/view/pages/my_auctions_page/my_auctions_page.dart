...
import 'my_auctions_page_model.dart';
export 'my_auctions_page_model.dart';
...
class _MyAuctionsPageState extends State<MyAuctionsPage> {
  late MyAuctionsPageModel _model;
  ...
  Future<void> getAuctions() async {
    if (!loading && page <= numberOfPages) {
      ...
      final responseMap = await get(createdByMe?"${ApiPaths.getAuctionCreatedByMy}$id&page=$page":"${ApiPaths.getAuctionAttendedByMy}$id?status=1&page=$page").onError((error, stackTrace) {
        return {
          'code':0,
          'error':error
        };
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyAuctionsPageModel());
                      ...
                      children: [
                        MaterialButton(
                          ...
                          child: Container(
                            ...
                            height: MediaQuery.sizeOf(context).height * 0.06,
                            decoration: createdByMe?BoxDecoration(
                              color: const Color(0xFF1C6166),
                            ...
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: FlutterFlowTheme.of(context)
                                    ...
                                    .override(
                                  fontFamily: 'Readex Pro',
                                  color: createdByMe?Colors.white:!loading?const Color(0xFF1C6166):Colors.grey,
                                ),
                              ),
                            ),
                          ),
                  ...
                  itemBuilder: (context, index) {
                    if (index < _model.auctions.length) {
                      ...
                      return wrapWithModel(
                        ...
                        child: AuctionCardWidget(auctionCardPosition: createdByMe?AuctionCardPosition.myAuctionCreatedByMe:AuctionCardPosition.myAuctionAttendedByMe,auction: _model.auctions[index],model: _model),
                      );
                    } else if (loading) {
